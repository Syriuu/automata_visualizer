    ...
    constructor (x, y) {
        ...
        document.body.insertAdjacentHTML('beforeend', `
            <div class="edit-menu" id="edit-node-menu">
                ...
                <div class="option" id="edit-node-menu-rename">
                    <i class="mdi mdi-pencil" aria-hidden="true" style="color: #ffb74d;"></i>Rename state
                </div>
            </div>`)
        ...
        document.querySelector('#edit-node-menu-rename').addEventListener('click', () => {
            this.dispatchEvent('renamestate')
        })
